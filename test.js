...
TrilateralRegularColor.__super__ = trilateralChange_AppGL;
TrilateralRegularColor.prototype = $extend(trilateralChange_AppGL.prototype,{
	draw: function(pen) {
		this.regular = trilateral3_shape_Regular._new(pen);
		var c = 1;
		this.count = c;
	...
	,renderDraw: function(pen) {
		if(this.tick > this.delayStart) {
			...
			while(_g < 8) {
				...
				var t = this.dStep;
				var col = col3.a;
				var r0 = (col >> 16 & 255) / 255;
				var g0 = (col >> 8 & 255) / 255;
				var b0 = (col & 255) / 255;
				var colNine = this.nines[this.count];
				var r1 = (colNine >> 16 & 255) / 255;
				var g1 = (colNine >> 8 & 255) / 255;
				var b1 = (colNine & 255) / 255;
				var v1 = t * t * t * (t * (t * 6.0 - 15.0) + 10.0);
				var r2 = r0 + v1 * (r1 - r0);
				var g2 = g0 + v1 * (g1 - g0);
				var b2 = b0 + v1 * (b1 - b0);
				var argb = new trilateral3_structure_ARGB(1.,r2,g2,b2);
				...
				pen.colorType.colorTriangles(color,startEnd.end - startEnd.start + 1 | 0);
				this.count++;
			}
...
function TrilateralRegularColor_main() {
	...
	haxe_Log.trace("TrilateralRegularColor example",{ fileName : "TrilateralRegularColor.hx", lineNumber : 33, className : "_TrilateralRegularColor.TrilateralRegularColor_Statics_", methodName : "main"});
}
...
var trilateral3_structure_ARGB = function(a,r,g,b) {
	this.b = 0.;
	this.g = 0.;
	this.r = 0.;
	this.a = 0.;
...
trilateral3_structure_ARGB.__name__ = true;
